...
namespace Krypton.Ribbon
{
    ...
    public class RibbonAppButton : Storage
    {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        [Editor("Krypton.Ribbon.KryptonRibbonRecentDocCollectionEditor, Krypton.Design, Version=4.70.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e", typeof(UITypeEditor))]
