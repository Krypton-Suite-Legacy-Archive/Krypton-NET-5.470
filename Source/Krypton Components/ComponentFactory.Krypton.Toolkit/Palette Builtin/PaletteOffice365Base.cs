...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    public abstract class PaletteOffice365Base : PaletteBase
    {
        ...
        #region Variables
        private KryptonColorTableOffice365 _table;

        private Color[] _ribbonColours, _trackBarColours;

        private ImageList _checkBoxList, _galleryButtonList;

        private Image[] _radioButtonArray;

        private Font _header1ShortFont, _header2ShortFont, _header1LongFont, _header2LongFont, _superToolFont, _headerFormFont, _buttonFont, _buttonFontNavigatorStack, _buttonFontNavigatorMini, _tabFontNormal, _tabFontSelected, _ribbonTabFont, _ribbonTabContextFont, _gridFont, _calendarFont, _calendarBoldFont, _boldFont, _italicFont;
