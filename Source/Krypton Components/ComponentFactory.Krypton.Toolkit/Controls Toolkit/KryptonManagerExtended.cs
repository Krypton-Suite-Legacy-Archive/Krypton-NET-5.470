...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    [ComVisible(true)]
    public class KryptonManagerExtended : Component, IPalette
    {
        #region Krypton Palette
        ...
        public InheritBool PaletteAllowFormChrome
        {
        ...
        private bool ShouldSerialisePaletteAllowFormChrome()
        {
            return (PaletteAllowFormChrome != InheritBool.Inherit);
        }
        #endregion
        ...
        public InheritBool GetAllowFormChrome() => PaletteAllowFormChrome == InheritBool.Inherit
            ? _basePalette.GetAllowFormChrome()
            : PaletteAllowFormChrome;
        ...
        public int ResumeUpdates(bool updateNow)
        {
            ...
            if (_suspendCount > 0)
            {
                ...
                {
                    OnThemePalettePaint(this, new PaletteLayoutEventArgs(true, true));
                ...
                if (_basePaletteMode != value)
                {
                    ...
                    switch (value)
                    {
                        ...
                        default:
                            ...
                            if (HasCircularReferencePalette())
                            {
                            ...
                            {
                                // Restore the original base pallete as 'SetThemePalette' will not 
                                // work correctly unles it still has the old value in place
                                _basePalette = tempPalette;
                            }

                            // Get a reference to the standard palette from its name
                            SetThemePalette(KryptonManager.GetPaletteForMode(_basePaletteMode));
        ...
        protected virtual void OnThemePalettePaint(object sender, PaletteLayoutEventArgs e)
        {
        ...
        #region Internal
        internal bool HasCircularReferencePalette()
        {
                    ...
                    if (palette is KryptonPalette owner)
                    {
                        ...
                        switch (owner.BasePaletteMode)
                        {
                            ...
                            case PaletteMode.Global:
                                palette = KryptonManagerExtended.InternalGlobalPalette;
                                break;
                            default:
                                palette = null;
                                break;
        ...
        private void OnMenuToolStatusPaint(object sender, NeedLayoutEventArgs e)
        {
            ...
            if (_suspendCount == 0)
            {
                ...
                OnThemePalettePaint(this, new PaletteLayoutEventArgs(e.NeedLayout, true));
            }
        }
        ...
        private void OnNeedPaint(object sender, NeedLayoutEventArgs e)
        {
            ...
            if (_suspendCount == 0)
            {
                ...
                OnThemePalettePaint(this, new PaletteLayoutEventArgs(e.NeedLayout, false));
            }
        }

        private void SetThemePalette(IPalette basePalette)
        {
            if (basePalette != _basePalette)
            {
                ...
                {
                    _basePalette.PalettePaint -= OnThemePalettePaint;
        ...
        /// <summary>
        /// Initializes the <see cref="KryptonManagerExtended"/> class.
        /// </summary>
        static KryptonManagerExtended()
        {
        ...
        public PaletteModeManager GlobalPaletteManagerMode
        {
        ...
        {
            return (GlobalPaletteManagerMode != PaletteModeManager.Office2010Blue);
        }

        /// <summary>
        /// Resets the GlobalPaletteManagerMode property to its default value.
        /// </summary>
        public void ResetGlobalPaletteMode()
        {
            GlobalPaletteManagerMode = PaletteModeManager.Office2010Blue;
        }
        ...
        #region Static Allow Form Chrome
        /// <summary>
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="KryptonManagerExtended"/> class.
        /// </summary>
        public KryptonManagerExtended()
        {
        ...
        public KryptonManagerExtended(IContainer container) : this()
        {
